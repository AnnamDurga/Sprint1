...
public class OrderRestController {
    ...
    public ResponseEntity<Order> updateUser(@RequestBody Order order,@PathVariable int orderId ) throws Exception
    {
        Order orderSaved=orderService.insertOrder(order);
